# Generated by Django 2.0 on 2022-03-22 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TrackingProject.Device')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TrackingProject.Company')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='TrackingProject.Company')),
        ...
        migrations.AddField(
            model_name='device',
            name='vehicle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TrackingProject.Vehicle'),
        ),
    ]
